...
export class SceneStudio{
  ...
  constructor(backgroundColor:string, cameraPosition:Vector3,cameraRotation:Vector3,fov:number,element:JQuery) {
  ...
  AddMouseControlCamera():void{
    ...
    let deltaMoveX=0,deltaMovey=0,lon=230,lat=0;
  ...
  Run():void{
    this.FireRayCasters();
    if(('onorientationchange' in window && this.devicecontrols)){
