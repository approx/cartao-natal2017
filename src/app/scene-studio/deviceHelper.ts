...
export class DeviceOrientationControls{
  ...
  connect():void{
    ...
    window.addEventListener('deviceorientation', (event:Event)=>{this.onDeviceOrientationChangeEvent(event)},false);
  ...
  disconnect():void{
    ...
    window.removeEventListener('deviceorientation', (event:Event)=>{this.onDeviceOrientationChangeEvent(event)},false);
